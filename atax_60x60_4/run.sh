...
/home/demo/build-rose/tests/nonsmoke/functional/roseTests/astInterfaceTests/loopUnrolling -c test3.c -rose:loopunroll:abstract_handle "Statement<position,19>" -rose:loopunroll:factor 4
...
#step 5: loop tiling for i in factor of 15
/home/demo/build-rose/tests/nonsmoke/functional/roseTests/astInterfaceTests/loopTiling -c test5.c -rose:loopTiling:abstract_handle "ForStatement<numbering,3>" -rose:loopTiling:depth 1 -rose:loopTiling:tilesize 15
...
/home/demo/build-rose/tests/nonsmoke/functional/roseTests/astInterfaceTests/loopUnrolling -c test9.c -rose:loopunroll:abstract_handle "Statement<position,60>" -rose:loopunroll:factor 4
